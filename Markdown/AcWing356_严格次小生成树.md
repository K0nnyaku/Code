---
title: AcWing356 严格次小生成树
date: 2021-11-02 20:19:19
tags: [图论, LCA, 最小生成树, 树上倍增]
---

### [AcWing356](https://www.acwing.com/problem/content/358/)

### 解
#### 求出最小生成树, 考虑将一条生成树上的边换成非树边
#### 一条非树边可以替换其组成的环上的任意边
#### 考虑更新环上的次大值和最大值
#### 树上倍增求两点到其LCA的最大值和次大值
* ##### P[x][i], x的2^i 级祖先
* ##### F[x][i][0/1] x到其2^i 级祖先的链上的最大值/次大值
