---
title: CQOI2015网络吞吐量
date: 2021-12-28 14:22:23
tags: [图论, 网络流, 最短路, Dic]
---

### [LG3171](https://www.luogu.com.cn/problem/P3171)

### 思路
* #### 按距离处理最短路, dfs将符合最短路的边留下
* #### 拆点确保流量

### 注意
* #### 起终点点权视为INF
* # 开longlong
* #### Far数组原图最短路和网络流共用, 注意拆点后大小*2
...
Edge<long long, N_<<1, M_<<1> I, G;
long long Far[N_<<1], W[N_];
int n, m, og, sk;
bool Vv[N_];
