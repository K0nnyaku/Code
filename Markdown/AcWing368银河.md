---
title: AcWing368 银河
date: 2021-11-08 18:19:29
tags: [SCC, Tarjan, 缩点, 差分约束, SPFA, 最长路, 拓扑排序]
---

### [AcWing368](https://www.acwing.com/problem/content/370/)

### 考虑每个SCC的边权和一定=0, 否则无解
### Tarjan缩点, DAG上拓扑排序dp求最长路, 然而缩点之后SPFA就可以卡过去
