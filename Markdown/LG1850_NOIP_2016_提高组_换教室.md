---
title: NOIP 2016 换教室
date: 2021-10-29 16:42:12
tags: [dp, 期望]
---

### [LG1850](https://www.luogu.com.cn/problem/P1850)

### 状态: F[i][v][0/1] 考虑到第i间教室, 已经申请了v间, 当前是否申请
		...
		if(v) {
			F[i][v][1] = F[i][v-1][0] * (1 - K[i]) + 
						 min(F[i-1][v-1][0] + E[C[i-1]][D[i]], 
							 F[i-1][v-1][1] + E[D[i-1]][D[i]] * K[i-1] + E[C[i-1]][D[i]] * (1-K[i-1]) );
