---
title: AcWing352 暗之连锁
date: 2021-11-2 14:08:12
tags: [LCA, 树上差分, 计数]
---

### [AcWing352](https://www.acwing.com/problem/content/354/)

### 附加边构成环, 对于每一条主要边, 设被环覆盖的次数为p, 则其对答案的贡献为
* #### p = 0 -> m
* #### p = 1 -> 1
* #### p > 1 -> 0

### 差分:
#### 对于每一条附加边(x, y), 令点权 W[x]+1, W[y]+1, W[LCA(x, y)] - 2, 则每个结点及其子树的权值和即为连接其父节点的边的被覆盖次数
