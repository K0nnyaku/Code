---
title: AC自动机_二次加强
date: 2022-1-8 9:09:12
tags: [字符串, AC自动机]
---

### [LG5357](https://www.luogu.com.cn/problem/P5357)

### 建图(BFS)过程中记录拓扑序, Fail树上计数
...
#define TN       (S[i]-'a')
	...
	void Ins(const string &S, int &end) {
		int p = rt;
		Ir(i, 0, S.size()) {
			int &ch = C(p, TN);
			p = ch ? ch : ch=++cnt;
