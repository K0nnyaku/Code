---
title: AcWing387 Arctic Network
date: 2021-11-14 5:32:32
tags: [图论, Kruskal, 最小生成树]
---

### [AcWing387](https://www.acwing.com/problem/content/description/389/)

### 考虑对于一颗最小生成树, 删掉最长的$s-1$条边, 则形成$s$颗子树, 其中每颗子树选一个点, 就是最优情况
### Kruskal, 添加的第 $n-s$ 条边的长度就是答案
