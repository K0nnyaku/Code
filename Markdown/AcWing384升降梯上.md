---
title: AcWing384 升降梯上
date: 2021-11-14 10:41:01
tags: [图论, 分层图, Dijkstra, dp, 最短路]
---

### [AcWing384](https://www.acwing.com/problem/content/description/386/)

### 解
#### 设 $F_{x, v}$表示到达第$x$层, 操作杆位于$v$的最短路
#### $F_{x, v}$可以更新
* ##### $F_{x+C_k, k}$ 为 $F_{x, v} + |v - k| + |2 * C_k|$, 即移动操作杆
* ##### $F_{x+nC_v, v}$ 为 $F_{x, v} + |2n * C_v|$, 即不移动操作杆
